...
public class Fragmentnext15 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Fragmentnext18 iq_karfragment;
    FragmentManager fragmentManager;
    public final String Fragennummer = "660";
    ...
    String h, youdData14, youdData13, youdData11, youdData12, youdData15, youdData16,
            ...
            youdData111, youdData25, youdData112, youdData113, youdData114, youdData115, youdData116, youdData117,
            youdData118, youdData119, youdData200, youdData211, youdData222, youdData233, youdData244,
            youdData255, youdData26, youdData266;
    Bundle bundle;
    ...
    public final String antwortVerschlusselCloudJa = "Ihre Verschlüsselung der Cloud sichert Sie zusätzlich ab.";
    public final String antwortVerschlusselCloudNein = "Eine Verschlüssung der Cloud bietet eine weitere Sicherheit. Sie sollten es potenziellen Hackern möglichst schwer machen, an ihre sensiblen Daten zu kommen. Das gilt für lokale Sicherungen von Daten ebenso, wie für Daten, die in einem Cloudspeicher bevorratet werden. " +
            "Hier müssen die Daten bereits beim Upload verschlüsselt werden.";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio15, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup15);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets15);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set151);
        bundle = getArguments();
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData24 + ":" + youdData244 + gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 +
                            gewichtung4 + gewichtung5 + gewichtung6 + gewichtung7 + gewichtung8 + gewichtung9 +gewichtung10 + gewichtung11 +
                            gewichtung12 +"\t" + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortVerschlusselCloudJa;
                    gewichtung13 = 1;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortVerschlusselCloudNein;
                    gewichtung13 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv15);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragmentnext18();
                bundle = new Bundle();
                ...
                bundle.putString("your_key25", h);
                bundle.putString("your_key255", antwortwahr);
        ...
        TextView linkTextView2 = root.findViewById(R.id.header15);
