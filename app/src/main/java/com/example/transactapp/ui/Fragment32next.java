...
public class Fragment32next extends Fragment {

    Fragment33next iq_karfragment;
    ...
    View root;
    public String Fragennummer = "970";
    ...
    String h, youdData14, youdData13, youdData11, youdData12, youdData15, youdData16,
            ...
            youdData355, youdData36, youdData366, youdData37, youdData377, youdData38, youdData388, youdData39, youdData399;
    Bundle bundle;
    ...
    int gewichtung, gew, gewichtung1, gewichtung2, gewichtung3, gewichtung4, gewichtung5,
            ...
            gewichtung23, gewichtung24, gewichtung25, gewichtung26 ;
    public final String antwortAnpassungneuenGeschäft = "Das bedeutet der erste Schritt in Richtung Transformation ist eingeleutet. [Sie planen aufgrund der digitalen Transformation ein neues Geschäftsmodell. Daher werden Sie gerade in der Planungsphase sehr genau planen müssen, damit das Geschäft auf die richtige Schiene gesetzt wird. Sie sollten" +
            " hier internen Sachverstand mit externer Beratung koppeln, um eine gute Planungsgrundlage zu erhalten.]";
    public final String antwortAnpassungneuenGeschäftNein = "Die Anpassung eines neuen Geschäftsmodells ist für eine Verbesserung und die Nutzung der eigenen Potenziale in Bezug auf eine " +
            "Transformation unumgänglich. Lassen Sie sich hierbei von Experten beraten.";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio32, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup32);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets32);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set32);
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData35 + ":" + youdData355 + youdData36 + ":" + youdData366 +youdData37 + ":" + youdData377 + gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 +
                            ...
                            gewichtung19 + gewichtung20 + gewichtung21+ gewichtung22+ gewichtung23+ gewichtung24 +gewichtung25 +"\t" + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortAnpassungneuenGeschäft;
                    gewichtung26 = 1;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortAnpassungneuenGeschäftNein;
                    gewichtung26 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv32);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragment33next();
                bundle = new Bundle();
                ...
                bundle.putString("your_key38", h);
                bundle.putString("your_key388", antwortwahr);
        ...
        linkTextView2 = root.findViewById(R.id.header32);
