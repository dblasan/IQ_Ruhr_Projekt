...
public class Fragmentnext18 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Fragmentnext19 iq_karfragment;
    FragmentManager fragmentManager;
    public final String Fragennummer = "720";
    ...
    String h, youdData14, youdData13, youdData11, youdData12, youdData15, youdData16,
            ...
            youdData244, youdData255,youdData266, youdData27, youdData277;
    Bundle bundle;
    ...
    public final String antwortInternerSachversJa = "In der betriebswirtschaftlichen Beratung setzen Sie auf internen Sachverstand. Das ist gut, denn hier besteht wahrscheinlich ein hohes Maß an Verständnis für die betriebswirtschaftlichen Zusammenhänge ihres Unternehmens. Bei Digitalisierungsvorgängen empfiehlt sich jedoch auch zusätzlich eine externe Beratung. Das schützt vor der gefährlichen Betriebsblindheit, " +
            "die sich in allen - auch in erfolgreichen - Unternehmen einschleichen kann. ";
    public final String antwortInternerSachversNein = "In der betriebswirtschaftlichen Beratungen setzen Sie auf keinen internen Sachverstand. " +
            "Hier sind Potenziale, die genutzt werden können.";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio18, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup18);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets18);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set181);
        bundle = getArguments();
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData20 + ":" + youdData200 + youdData21 + ":" + youdData211 + youdData22 + ":" + youdData222 + youdData23 + ":" + youdData233 +
                            youdData24 + ":" + youdData244 + youdData25 + ":" + youdData255 + gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 +
                            gewichtung4 + gewichtung5 + gewichtung6 + gewichtung7 + gewichtung8 + gewichtung9 +gewichtung10 + gewichtung11 +
                            gewichtung12 + gewichtung13 + "\t" + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortInternerSachversJa;
                    gewichtung14 = 0;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortInternerSachversNein;
                    gewichtung14 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv18);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragmentnext19();
                bundle = new Bundle();
                ...
                bundle.putString("your_key26", h);
                bundle.putString("your_key266", antwortwahr);
        ...
        TextView linkTextView2 = root.findViewById(R.id.header18);
