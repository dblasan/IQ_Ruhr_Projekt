...
public class Lieferant16 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Lieferant17 iq_karfragment;
    ...
    public final String antwortwahreinsatzki = "Ihr Lieferant setzt sich mit dem Thema \"Künstliche Intelligenz\" bereits auseinander. " +
            "Dies zeigt, dass er sich mit aktuellen Themen befasst. ";
    public final String antwortfalscheinsatzki = "Künstliche Intelligenz wird in den nächsten Jahren in weiteren Branchen Anwendung finden und in die Unternehmen integriert werden. Auch wenn das heute für " +
            "Ihren Lieferanten noch nicht sichtbar ist. Machen Sie Ihren Lieferanten darauf aufmerksam. ";
    String antwortwahr, youdData1, youdData11, youdData2, youdData22, youdData3, youdData33,
            ...
            youdData12, youdData112, youdData13, youdData113, youdData14, youdData114, youdData15, youdData115, h;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragmenlieferant16, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.liefer_radiogroup16);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.lierant_16tset1);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.lierant_16tset2);
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 2 ", "Vorherige RadioButton Auswahl: " + youdData1 + youdData11 + "\t" + youdData2 +
                            ...
                            youdData15 + youdData115 +gewichtung + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortwahreinsatzki;
                    gewichtung16 = 2;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortfalscheinsatzki;
                    gewichtung16 = 0;
                    result1 = myDb.updateAntwortJa1(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_16tv);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Lieferant17();
                bundle = new Bundle();
                ...
                bundle.putString("lief_key16", h);
                bundle.putString("lief_key116", antwortwahr);
