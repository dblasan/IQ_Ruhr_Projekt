...
public class Fragment35next extends Fragment {

    FragmentMain iq_karfragment;
    ...
    View root;
    public String Fragennummer = "1030";
    ...
    Bundle bundle;
    public final String antwortQualifizierungskonzeptja = "Ein Qualifizierungskonzept organisiert die Qualifizierungen der Mitarbeiter und hilft " +
            "bei der Übersicht und Planung der einzelnen Qualifizerungsmaßnahmen.";
    public final String antwortQualifizierungskonzeptNein = "Ein Qualifizierungskonzept würde Ihre Qualifizierungsmaßnahmen besser koordinieren und klare Zielvorgaben beinhalten. Lassen Sie " +
            "sich hierfür von Experten beraten und stellen Sie ein nachhaltiges Qualifizierungskonzept auf. ";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio35, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup35);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets35);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set35);
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 +
                            ...
                            gewichtung25 + gewichtung26+ gewichtung27 + gewichtung28 +"\t" + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortQualifizierungskonzeptja;
                    gewichtung29 = 1;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortQualifizierungskonzeptNein;
                    gewichtung29 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv35);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new FragmentMain();
                bundle = new Bundle();
        ...
        linkTextView2 = root.findViewById(R.id.header35);
