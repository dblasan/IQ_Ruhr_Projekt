...
public class Fördermittelfragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragmentfoerder, container, false);
        ...
        TextView linkTextView3 = root.findViewById(R.id.foerdern);
        linkTextView3.setMovementMethod(LinkMovementMethod.getInstance());
        linkTextView3.setTypeface(null, Typeface.BOLD);
        TextView linkTextView4 = root.findViewById(R.id.foerdertext);
