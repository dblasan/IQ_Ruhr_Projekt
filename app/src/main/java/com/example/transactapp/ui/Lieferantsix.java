...
public class Lieferantsix extends Fragment {

    public final String Fragennummer = "280";
    public final String antwortwahrlieferSonderwunsch = ".";
    public final String antwortfalschlieferSonderwunsch = "Die Unflexibilität Ihres Lieferanten nimmt Ihnen die Chance ein auf Sie optimal " +
            "zugeschnittenes Angebot in Anspruch zu nehmen. ";
    public String Themenbereich;
    public String InhaltderFrage;
    public String antwortbutton;
    public String antwortnichtwahr;
    FloatingActionButton fab;
    Lieferantseven iq_karfragment;
    ...
    String antwortwahr, youdData1, youdData11, youdData2, youdData22, youdData3,
            youdData4, youdData44, youdData5, youdData55, youdData33, h;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragmenlieferantsix, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.liefer_radiogroup);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.lierant_sixset1);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.lierant_sixset2);
                ...
                if (rgroup.getCheckedRadioButtonId() == -1) {
                    ...
                    if (h.equals("ja") || (h.equals("Nein"))) {
                        Log.d("Button 2 ", "Vorherige RadioButton Auswahl: " + youdData1 + youdData11 + "\t" + youdData2 +
                                youdData22 + youdData3 + youdData33 + youdData4 + youdData44 + youdData5 + youdData55 +
                                gewichtung + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + "aktuelle Auswahl: " + h);
                        radioSexButton.setChecked(true);
                        antwortbutton = h;
                    }

                    if (h.equals("ja")) {
                        antwortwahr = antwortwahrlieferSonderwunsch;
                        gewichtung6 = 2;
                    ...
                    if (h.equals("Nein")) {
                        antwortwahr = antwortfalschlieferSonderwunsch;
                        gewichtung6 = 0;
                        result1 = myDb.updateAntwortJa1(antwortwahr, Fragennummer);
                        if (result1) {
                            Log.d("Successfully 1", "Updated");
                    ...
                    TextView tv = (TextView) root.findViewById(R.id.avg_sixtv);
                    tv.setMovementMethod(LinkMovementMethod.getInstance());
                    iq_karfragment = new Lieferantseven();
                    bundle = new Bundle();
                    ...
                    bundle.putString("lief_key6", h);
                    bundle.putString("lief_key66", antwortwahr);
