...
public class Lieferant18 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Lieferant19 iq_karfragment;
    ...
    public final String antwortwahrZertifizierung = ".";
    public final String antwortfalschZertifizierung = "Achten Sie darauf, dass bei der digitalen Transformation alles zum Qualitätsmanagement passt " +
            "und die erforderlichen Zertifizierungen nicht gefährdet sind. ";
    ...
    String antwortwahr, youdData1, youdData11, youdData2, youdData22, youdData3, youdData33,
            ...
            youdData16, youdData116,  youdData17, youdData117, h;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragmenlieferant18, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.liefer_radiogroup18);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.lierant_18tset1);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.lierant_18tset2);
        bundle = getArguments();
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 2 ", "Vorherige RadioButton Auswahl: " + youdData1 + youdData11 + "\t" + youdData2 +
                            ...
                            youdData15 + youdData115 + youdData16 + youdData116 + youdData17 + youdData117 +gewichtung + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5
                            + gewichtung6 + gewichtung7 + gewichtung8 + gewichtung9 + gewichtung10 + gewichtung11 + gewichtung12 + gewichtung13 +
                            gewichtung14 + gewichtung15 + gewichtung16 + gewichtung17 +"aktuelle Auswahl: " + h);
                    radioSexButton.setChecked(true);
                    antwortbutton = h;
                }

                if (h.equals("ja")) {
                    antwortwahr = antwortwahrZertifizierung;
                    gewichtung18 = 1;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortfalschZertifizierung;
                    gewichtung18 = 0;
                    result1 = myDb.updateAntwortJa1(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_18tv);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Lieferant19();
                bundle = new Bundle();
                ...
                bundle.putString("lief_key18", h);
                bundle.putString("lief_key118", antwortwahr);
