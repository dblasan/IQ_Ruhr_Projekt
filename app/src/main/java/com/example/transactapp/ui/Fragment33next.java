...
public class Fragment33next extends Fragment {

    Fragment34next iq_karfragment;
    ...
    View root;
    public String Fragennummer = "990";
    ...
    String h, youdData14, youdData13, youdData11, youdData12, youdData15, youdData16,
            ...
            youdData399,youdData40, youdData400;
    Bundle bundle;
    ...
    int gewichtung, gew, gewichtung1, gewichtung2, gewichtung3, gewichtung4, gewichtung5,
            ...
            gewichtung23, gewichtung24, gewichtung25, gewichtung26, gewichtung27;
    public final String antwortAnneueMärkteidentJa = ".";
    public final String antwortAnneueMärkteidentnein = "Für die Implementierung eines neuen Geschäftsmodells ist die " +
            "Identikation und Analyse potenzieller Märkte wichtig, da es die de Rahmenbedingungen setzt. ";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio33, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup33);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets33);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set33);
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData38 + ":" + youdData388 +gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 +
                            ...
                            gewichtung25 + gewichtung26 + "\t" + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortAnneueMärkteidentJa;
                    gewichtung27 = 1;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortAnneueMärkteidentnein;
                    gewichtung27 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv33);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragment34next();
                bundle = new Bundle();
                ...
                bundle.putString("your_key39", h);
                bundle.putString("your_key399", antwortwahr);
        ...
        linkTextView2 = root.findViewById(R.id.header33);
