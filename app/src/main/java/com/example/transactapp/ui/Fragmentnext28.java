...
public class Fragmentnext28 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Fragmentnext29 iq_karfragment;
    FragmentManager fragmentManager;
    public final String Fragennummer = "930";
    ...
    String h, youdData14, youdData13, youdData11, youdData12, youdData15, youdData16,
            ...
            youdData355, youdData36, youdData366, youdData37, youdData377, youdData38;
    Bundle bundle;
    ...
    public final String antwortBereitseingebunJa = ".";
    public final String antwortBereitseingebunNein = ".";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio28, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup28);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets28);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set281);
        bundle = getArguments();
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData32 + ":" + youdData322 +  youdData33 + ":" + youdData333 + gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 +
                            ...
                            gewichtung19 + gewichtung20 + gewichtung21+ "\t" + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortBereitseingebunJa;
                    gewichtung22 = 1;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortBereitseingebunNein;
                    gewichtung22 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv28);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragmentnext29();
                bundle = new Bundle();
                ...
                bundle.putString("your_key34", h);
                bundle.putString("your_key344", antwortwahr);
        ...
        TextView linkTextView2 = root.findViewById(R.id.header28);
