...
public class Lieferant15 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Lieferant16 iq_karfragment;
    FragmentManager fragmentManager;
    public final String Fragennummer = "500";
    ...
    public final String antwortwahrDatenverschluss = ".";
    public final String antwortfalschDatenverschluss = "Eine Verschlüsselung der Daten bietet eine weitere Sicherheit. So wird es " +
            "potenziellen Hackern möglichst schwer gemacht an sensible Daten zu kommen. ";
    String antwortwahr, youdData1, youdData11, youdData2, youdData22, youdData3, youdData33,
            ...
            youdData12, youdData112, youdData13, youdData113, youdData14, youdData114, h;
    int gewichtung, gewichtung2, gewichtung3, gewichtung4, gewichtung5, gewichtung6,
            ...
            gewichtung12, gewichtung13, gewichtung14, gewichtung15;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragmenlieferant15, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.liefer_radiogroup15);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.lierant_15tset1);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.lierant_15tset2);
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 2 ", "Vorherige RadioButton Auswahl: " + youdData1 + youdData11 + "\t" + youdData2 +
                            ...
                            youdData111 +youdData1111+ youdData12+ youdData112 + youdData13+ youdData113 + youdData14 + youdData114 +gewichtung + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortwahrDatenverschluss;
                    gewichtung15 = 2;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortfalschDatenverschluss;
                    gewichtung15 = 0;
                    result1 = myDb.updateAntwortJa1(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_15tv);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Lieferant16();
                bundle = new Bundle();
                ...
                bundle.putString("lief_key15", h);
                bundle.putString("lief_key115", antwortwahr);
