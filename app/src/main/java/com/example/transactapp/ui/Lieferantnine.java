...
public class Lieferantnine extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    LieferantTen iq_karfragment;
    ...
    public final String antwortwahrPersonalProb = "Personalprobleme können sich negativ auf Ihre Lieferungen auswirken.";
    public final String antwortfalschPersonalProb = ".";
    String antwortwahr, youdData1, youdData11, youdData2, youdData22, youdData3,
            youdData4, youdData44, youdData5, youdData55, youdData6, youdData66, youdData7, youdData77, youdData8, youdData88,
            youdData33, h;
    int gewichtung, gewichtung2, gewichtung3, gewichtung4, gewichtung5, gewichtung6, gewichtung7, gewichtung8, gewichtung9;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragmenlieferantnine, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.liefer_radiogroup9);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.lierant_ninetset1);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.lierant_ninetset2);
        bundle = getArguments();
                ...
                if (rgroup.getCheckedRadioButtonId() == -1) {
                    ...
                    if (h.equals("ja") || (h.equals("Nein"))) {
                        Log.d("Button 2 ", "Vorherige RadioButton Auswahl: " + youdData1 + youdData11 + "\t" + youdData2 +
                                ...
                                youdData7 + youdData77 + youdData8 + youdData88 + gewichtung + gewichtung2 + gewichtung3 + gewichtung4 +
                                gewichtung5 + gewichtung6 + gewichtung7 + gewichtung8 + "aktuelle Auswahl: " + h);
                        radioSexButton.setChecked(true);
                        antwortbutton = h;
                    }

                    if (h.equals("ja")) {
                        antwortwahr = antwortwahrPersonalProb;
                        gewichtung9 = 0;
                    ...
                    if (h.equals("Nein")) {
                        antwortwahr = antwortfalschPersonalProb;
                        gewichtung9 = 1;
                        result1 = myDb.updateAntwortJa1(antwortwahr, Fragennummer);
                        if (result1) {
                            Log.d("Successfully 1", "Updated");
                    ...
                    TextView tv = (TextView) root.findViewById(R.id.avg_ninetv);
                    tv.setMovementMethod(LinkMovementMethod.getInstance());
                    iq_karfragment = new LieferantTen();
                    bundle = new Bundle();
                    ...
                    bundle.putString("lief_key9", h);
                    bundle.putString("lief_key99", antwortwahr);
