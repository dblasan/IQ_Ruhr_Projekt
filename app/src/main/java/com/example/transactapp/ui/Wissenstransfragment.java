...
public class Wissenstransfragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_wissens, container, false);
        ...
        TextView linkTextView3 = root.findViewById(R.id.wissentransf);
        linkTextView3.setMovementMethod(LinkMovementMethod.getInstance());
        linkTextView3.setTypeface(null, Typeface.BOLD);
        TextView linkTextView4 = root.findViewById(R.id.Wissenstransfertext);
        linkTextView4.setMovementMethod(LinkMovementMethod.getInstance());
        TextView linkTextView2 = root.findViewById(R.id.uberiqruhr);
