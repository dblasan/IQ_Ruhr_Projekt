...
public class Lieferant19 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Lieferant20 iq_karfragment;
    ...
    public final String antwortwahrAnpassungGeschäft = "Ihr Lieferant hat den ersten Schritt in Richtung einer Transformation eingeläutet.";
    public final String antwortfalschAnpassungGeschäft = "Die Anpassung eines neuen Geschäftsmodells ist für eine Verbesserung und die Nutzung der eigenen " +
            "Potenziale in Bezug auf eine Transformation unumgänglich. ";
    String antwortwahr, youdData1, youdData11, youdData2, youdData22, youdData3, youdData33,
            ...
            youdData16, youdData116,  youdData17, youdData117, youdData18, youdData118,h;
    ...
    int gewichtung, gewichtung2, gewichtung3, gewichtung4, gewichtung5, gewichtung6,
            ...
            gewichtung17, gewichtung18, gewichtung19;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragmenlieferant19, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.liefer_radiogroup19);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.lierant_19tset1);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.lierant_19tset2);
        bundle = getArguments();
                ...
                if (rgroup.getCheckedRadioButtonId() == -1) {
                    ...
                    if (h.equals("ja") || (h.equals("Nein"))) {
                        Log.d("Button 2 ", "Vorherige RadioButton Auswahl: " + youdData1 + youdData11 + "\t" + youdData2 +
                                ...
                                youdData15 + youdData115 + youdData16 + youdData116 + youdData17 + youdData117 + youdData18 + youdData118 + gewichtung + gewichtung2 +
                                gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 + gewichtung7 + gewichtung8 + gewichtung9 + gewichtung10 + gewichtung11 +
                    ...
                    if (h.equals("ja")) {
                        antwortwahr = antwortwahrAnpassungGeschäft;
                        gewichtung19 = 2;
                    ...
                    if (h.equals("Nein")) {
                        antwortwahr = antwortfalschAnpassungGeschäft;
                        gewichtung19 = 0;
                        result1 = myDb.updateAntwortJa1(antwortwahr, Fragennummer);
                        if (result1) {
                            Log.d("Successfully 1", "Updated");
                    ...
                    TextView tv = (TextView) root.findViewById(R.id.avg_19tv);
                    tv.setMovementMethod(LinkMovementMethod.getInstance());
                    iq_karfragment = new Lieferant20();
                    bundle = new Bundle();
                    ...
                    bundle.putString("lief_key19", h);
                    bundle.putString("lief_key119", antwortwahr);
