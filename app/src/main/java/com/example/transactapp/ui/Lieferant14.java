...
public class Lieferant14 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Lieferant15 iq_karfragment;
    FragmentManager fragmentManager;
    public final String Fragennummer = "480";
    ...
    public final String antwortwahrRichtliniepolicie = ".";
    public final String antwortfalschRichtliniepolicie = "Richtlinien und Policies sind sinnvoll. Mit ihnen lassen sich die Handlungsweisen der Beschäftigten besser regeln. Besonders wichtig ist dies an sehr verwundbaren Stellen, z. B. dem Umgang mit Schnittstellen zu externen Datenträgern oder den Umgang mit Daten allgemein. " +
            "Verschriftliche Regeln sind verbindlicher als mündlich herausgegebene Anweisungen. ";
    String antwortwahr, youdData1, youdData11, youdData2, youdData22, youdData3, youdData33,
            ...
            youdData12, youdData112, youdData13, youdData113, h;
    int gewichtung, gewichtung2, gewichtung3, gewichtung4, gewichtung5, gewichtung6,
            ...
            gewichtung12, gewichtung13, gewichtung14;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragmenlieferant14, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.liefer_radiogroup14);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.lierant_14tset1);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.lierant_14tset2);
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 2 ", "Vorherige RadioButton Auswahl: " + youdData1 + youdData11 + "\t" + youdData2 +
                            ...
                            youdData111 +youdData1111+ youdData12+ youdData112 + youdData13+ youdData113 +gewichtung + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortwahrRichtliniepolicie;
                    gewichtung14 = 1;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortfalschRichtliniepolicie;
                    gewichtung14 = 0;
                    result1 = myDb.updateAntwortJa1(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_14tv);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Lieferant15();
                bundle = new Bundle();
                ...
                bundle.putString("lief_key14", h);
                bundle.putString("lief_key114", antwortwahr);
