...
public class Fragmentnext30 extends Fragment implements RadioGroup.OnCheckedChangeListener {
    Fragment31next iq_karfragment;
    ...
    View root;
    public String Fragennummer = "100";
    ...
    String h, youdData14, youdData13, youdData11, youdData12, youdData15, youdData16,
            ...
            youdData39, youdData399, youdData40;
    Bundle bundle;
    int gewichtung, gew, gewichtung1, gewichtung2, gewichtung3, gewichtung4, gewichtung5,
            ...
            gewichtung18, gewichtung19, gewichtung20, gewichtung21, gewichtung22, gewichtung23, gewichtung24;
    public final String antwortProduzierendesGew = "Als produzierendes Gewerbe ist Ihr Unternehmen wahrscheinlich Teil des Industriesektors und wird vor allem durch maschinelle Produktion, Arbeitsteilung und Fertigung größerer Stückzahlen gekennzeichnet. Bedingt durch den traditionell hohen Technologisierungsgrad und dem weit verbreitenden Maschineneinsatz ist " +
            "die Digitalisierung im produzierenden Gewerbe bereits weit verbreitet und gewinnt zunehmend an Bedeutung.";
    public final String antwortDiensleistung = "Als Dienstleistungsunternehmen kennzeichnet sich Ihr Produkt wahrscheinlich durch eine Immaterialität, Untrennbarkeit von Dienstleister und Dienstleistung, mangelnde Lager- " +
            "und Transportfähigkeit sowie Synchronität von Herstellung und Verbrauch der Dienstleistung aus.";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio30, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup30);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (h.equals("Produzierendes Gewerbe") || (h.equals("Dienstleistung"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData35 + ":" + youdData355 +gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 +
                            ...
                            gewichtung19 + gewichtung20 + gewichtung21+ gewichtung22+ gewichtung23 + "\t" + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("Produzierendes Gewerbe")) {
                    antwortwahr = antwortProduzierendesGew;
                    gewichtung24 = 0;
                ...
                if (h.equals("Dienstleistung")) {
                    antwortwahr = antwortDiensleistung;
                    gewichtung24 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv30);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragment31next();
                bundle = new Bundle();
                ...
                bundle.putString("your_key36", h);
                bundle.putString("your_key366", antwortwahr);
        ...
        linkTextView2 = root.findViewById(R.id.header30);
