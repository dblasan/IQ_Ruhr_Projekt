...
public class Lieferant21 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    HauptLieferfragment iq_karfragment;
    ...
    public final String antwortwahrQualifkonzept = "Ein Qualifizierungskonzept organisiert die Qualifizierungen der Mitarbeiter und hilft bei " +
            "der Übersicht und Planung der einzelnen Qualifizierungsmaßnahmen. ";
    public final String antwortfalschQualifkonzept = "Ein Qualifizierungskonzept würde die Qualifizierungsmaßnahmen Ihres Lieferanten besser koordinieren " +
            "und klare Zielvorgaben beinhalten. ";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragmenlieferant21, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.liefer_radiogroup21);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.lierant_21tset1);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.lierant_21tset2);
        bundle = getArguments();
                ...
                if (rgroup.getCheckedRadioButtonId() == -1) {
                    ...
                    if (h.equals("ja") || (h.equals("Nein"))) {
                        Log.d("Button 2 ", "Vorherige RadioButton Auswahl: " + youdData1 + youdData11 + "\t" + youdData2 +
                                ...
                                youdData15 + youdData115 + youdData16 + youdData116 + youdData17 + youdData117 + youdData18 + youdData118 + youdData19 + youdData119 + youdData20 + youdData200 +
                                ...
                                gewichtung12 + gewichtung13 + gewichtung14 + gewichtung15 + gewichtung16 + gewichtung17 + gewichtung18 + gewichtung19 + gewichtung20 + "aktuelle Auswahl: " + h);
                    ...
                    if (h.equals("ja")) {
                        antwortwahr = antwortwahrQualifkonzept;
                        gewichtung21 = 2;
                    ...
                    if (h.equals("Nein")) {
                        antwortwahr = antwortfalschQualifkonzept;
                        gewichtung21 = 0;
                        result1 = myDb.updateAntwortJa1(antwortwahr, Fragennummer);
                        if (result1) {
                            Log.d("Successfully 1", "Updated");
                    ...
                    TextView tv = (TextView) root.findViewById(R.id.avg_21tv);
                    tv.setMovementMethod(LinkMovementMethod.getInstance());
                    iq_karfragment = new HauptLieferfragment();
                    bundle = new Bundle();
