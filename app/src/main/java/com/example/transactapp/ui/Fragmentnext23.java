...
public class Fragmentnext23 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Fragmentnext24 iq_karfragment;
    FragmentManager fragmentManager;
    public final String Fragennummer = "820";
    ...
    int gewichtung, gew, gewichtung1, gewichtung2, gewichtung3, gewichtung4, gewichtung5,
            ...
            gewichtung14, gewichtung15, gewichtung16, gewichtung17, gewichtung18;
    Bundle bundle;
    public final String antwortMöglichkklarJa = "Die Einsatzmöglichkeiten der Künstlichen Intelligenz sind Ihnen klar. Sehr gut. Das heißt, dass Sie sich bereits grundsätzlich mit dem Thema befasst haben und das" +
            " Thema KI in Ihrer Branche angekommen ist.";
    public final String antwortMöglichkklarNein = "Künstliche Intelligenz ist für Sie heute noch kein Thema. Das mag branchenspezifisch sein, ist aber in der Regel untypisch. Künstliche Intelligenz begleitet Sie in ihrem Alltag bereits überall, auch wenn sie das nicht vermuten, z.B. der Verkehrszeichenerkennung in Ihrem Auto. Wir empfehlen Ihnen, " +
            "die Einsatzmöglichkeiten von KI in Ihrem Betrieb mit Experten zu prüfen.";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio23, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup23);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets23);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set231);
        bundle = getArguments();
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData29 + ":" + youdData299 + gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 +
                            gewichtung7 + gewichtung8 + gewichtung9 +gewichtung10 + gewichtung11 +
                            gewichtung12 + gewichtung13 + gewichtung14 + gewichtung15 + gewichtung16 + gewichtung17 + "\t" + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortMöglichkklarJa;
                    gewichtung18 = 4;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortMöglichkklarNein;
                    gewichtung18= 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv23);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragmentnext24();
                bundle = new Bundle();
                ...
                bundle.putString("your_key30", h);
                bundle.putString("your_key300", antwortwahr);
        ...
        TextView linkTextView2 = root.findViewById(R.id.header23);
