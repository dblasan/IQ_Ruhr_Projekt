...
public class Fragmentnext24 extends Fragment {
    ...
    public final String Fragennummer = "840";
    public final String antwortkommtzumeinsatzJa = "Wenn Sie Ihre Branche betrachten, sehen Sie, dass KI bereits im Einsatz ist. Es ist daher für Sie von elementarer Bedeutung, das Rennen um die besten KI-gesteuerten Prozesse zu gewinnen. " +
            "Dies wird KI wahrscheinlich in den nächsten Jahren an Bedeutung gewinnen.";
    public final String antwortkommtzumeinsatzNein = "Künstliche Intelligenz wird in den nächsten Jahren in weiteren Branchen Anwendung finden und in die Unternehmen integriert werden. Auch wenn das heute für Sie noch nicht sichtbar ist. Sie können sicher sein, " +
            "dass sich Wettbewerber auf den Einsatz der KI vorbereitet. ";
    ...
    String h, youdData14, youdData13, youdData11, youdData12, youdData15, youdData16,
            ...
            youdData322, youdData33, youdData333, youdData34;
    Bundle bundle;
    ...
    int gewichtung, gew, gewichtung1, gewichtung2, gewichtung3, gewichtung4, gewichtung5,
            ...
            gewichtung14, gewichtung15, gewichtung16, gewichtung17, gewichtung18, gewichtung19;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio24, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup24);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets24);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set241);
        bundle = getArguments();
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData29 + ":" + youdData299 + youdData30 + ":" + youdData300 + gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 +
                            gewichtung7 + gewichtung8 + gewichtung9 + gewichtung10 + gewichtung11 +
                            gewichtung12 + gewichtung13 + gewichtung14 + gewichtung15 + gewichtung16 + gewichtung17 + gewichtung18 + "\t" + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortkommtzumeinsatzJa;
                    gewichtung19 = 4;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortkommtzumeinsatzNein;
                    gewichtung19 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv24);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragmentnext25();
                bundle = new Bundle();
                ...
                bundle.putString("your_key31", h);
                bundle.putString("your_key311", antwortwahr);
        ...
        TextView linkTextView2 = root.findViewById(R.id.header24);
