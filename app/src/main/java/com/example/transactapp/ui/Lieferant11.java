...
public class Lieferant11 extends Fragment {

    public final String Fragennummer = "420";
    public final String antwortwahrersatzlieferant = ".";
    public final String antwortfalschersatzlieferant = "Über einen Ersatzlieferanten zu verfügen ist sinnvoll und verhindet zu " +
            "starke Abhängigkeiten zu einzelnen Lieferanten. ";
    public String Themenbereich;
    public String InhaltderFrage;
    public String antwortbutton;
    public String antwortnichtwahr;
    FloatingActionButton fab;
    Lieferant12 iq_karfragment;
    ...
    String antwortwahr, youdData1, youdData11, youdData2, youdData22, youdData3,
            ...
            youdData8, youdData88, youdData9, youdData99, youdData10, youdData100, youdData33, h;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragmenlieferant11, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.liefer_radiogroup11);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.lierant_11tset1);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.lierant_11set2);
                ...
                if (rgroup.getCheckedRadioButtonId() == -1) {
                    ...
                    if (h.equals("ja") || (h.equals("Nein"))) {
                        Log.d("Button 2 ", "Vorherige RadioButton Auswahl: " + youdData1 + youdData11 + "\t" + youdData2 +
                                ...
                                youdData7 + youdData77 + youdData8 + youdData88 + youdData9 + youdData99 + youdData10 + youdData100 + gewichtung + gewichtung2 + gewichtung3 + gewichtung4 +
                                gewichtung5 + gewichtung6 + gewichtung7 + gewichtung8 + gewichtung9 + gewichtung10 + "aktuelle Auswahl: " + h);
                        radioSexButton.setChecked(true);
                        antwortbutton = h;
                    }

                    if (h.equals("ja")) {
                        antwortwahr = antwortwahrersatzlieferant;
                        gewichtung11 = 2;
                    ...
                    if (h.equals("Nein")) {
                        antwortwahr = antwortfalschersatzlieferant;
                        gewichtung11 = 0;
                        result1 = myDb.updateAntwortJa1(antwortwahr, Fragennummer);
                        if (result1) {
                            Log.d("Successfully 1", "Updated");
                    ...
                    TextView tv = (TextView) root.findViewById(R.id.avg_11tv);
                    tv.setMovementMethod(LinkMovementMethod.getInstance());
                    iq_karfragment = new Lieferant12();
                    bundle = new Bundle();
                    ...
                    bundle.putString("lief_key111", h);
                    bundle.putString("lief_key1111", antwortwahr);
