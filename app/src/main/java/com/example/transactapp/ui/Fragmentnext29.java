...
public class Fragmentnext29 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Fragmentnext30 iq_karfragment;
    FragmentManager fragmentManager;
    public final String Fragennummer = "950";
    ...
    String h, youdData14, youdData13, youdData11, youdData12, youdData15, youdData16,
            ...
            youdData322, youdData33, youdData333, youdData34, youdData344;
    Bundle bundle;
    ...
    int gewichtung, gew, gewichtung1, gewichtung2, gewichtung3, gewichtung4, gewichtung5,
            ...
            gewichtung18, gewichtung19, gewichtung20, gewichtung21, gewichtung22, gewichtung23;
    public final String antwortAufsichratJa = ".";
    public final String antwortAufsichratNein = ".";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio29, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup29);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets29);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set291);
        bundle = getArguments();
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData32 + ":" + youdData322 +  youdData33 + ":" + youdData333 +youdData34 + ":" + youdData344 + gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 +
                            ...
                            gewichtung19 + gewichtung20 + gewichtung21+ gewichtung22 + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortAufsichratJa;
                    gewichtung23 = 1;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortAufsichratNein;
                    gewichtung23 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv29);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragmentnext30();
                bundle = new Bundle();
                ...
                bundle.putString("your_key35", h);
                bundle.putString("your_key355", antwortwahr);
        ...
        TextView linkTextView2 = root.findViewById(R.id.header29);
