...
public class Fragment31next  extends Fragment {

    Fragment32next iq_karfragment;
    ...
    View root;
    public String Fragennummer = "860";
    ...
    int gewichtung, gew, gewichtung1, gewichtung2, gewichtung3, gewichtung4, gewichtung5,
            ...
            gewichtung23, gewichtung24, gewichtung25 ;
    public final String antwortWettbewerbja = ".";
    public final String antwortWettbewerbNein = "In den nächsten Jahren ist davon auszugehen, dass Ihre Wettbewerber KI nutzen werden.";
    public final String antwortWettbewerbNichtklar = "Es ist davon auszugehen, dass Wettbewerber KI bereits nutzen bzw. testen. ";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio31, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup31);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets31);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set311);
        simpleRadioButton3 = (RadioButton) root.findViewById(R.id.two_set312);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein")) || (h.equals("nicht klar"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData35 + ":" + youdData355 + youdData36 + ":" + youdData366 + gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 +
                            ...
                            gewichtung19 + gewichtung20 + gewichtung21+ gewichtung22+ gewichtung23+ gewichtung24 +"\t" + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortWettbewerbja;
                    gewichtung25 = 0;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortWettbewerbNein;
                    gewichtung25 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                if (h.equals("nicht klar")) {
                    antwortwahr = antwortWettbewerbNichtklar;
                    gewichtung25 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv31);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragment32next();
                bundle = new Bundle();
                ...
                bundle.putString("your_key37", h);
                bundle.putString("your_key377", antwortwahr);
        ...
        linkTextView2 = root.findViewById(R.id.header31);
