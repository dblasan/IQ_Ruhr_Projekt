...
public class Lieferant20 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Lieferant21 iq_karfragment;
    FragmentManager fragmentManager;
    public final String Fragennummer = "680";
    ...
    public final String antwortwahrLieferantQualif = "Qualifizierungen von Mitarbeitern sind ein entscheidender " +
            "Baustein bei der Transformation eines Unternehmens. ";
    public final String antwortfalschLieferantQualif = "Ohne Qualifizierungen von Mitarbeitern lässt sich ein Unternehmen nur schwer umstrukturieren. Neue Themen benötigen neue Kompetenzen der Mitarbeiter, sodass die Transformation " +
            "als Ganzes bei den einzelnen Bausteinen, den Mitarbeitern, beginnt. ";
    String antwortwahr, youdData1, youdData11, youdData2, youdData22, youdData3, youdData33,
            ...
            youdData16, youdData116,  youdData17, youdData117, youdData18, youdData118, youdData19,youdData119, h;
    ...
    int gewichtung, gewichtung2, gewichtung3, gewichtung4, gewichtung5, gewichtung6,
            ...
            gewichtung17, gewichtung18, gewichtung19, gewichtung20;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragmenlieferant20, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.liefer_radiogroup20);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.lierant_20tset1);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.lierant_20tset2);
        bundle = getArguments();
                ...
                if (rgroup.getCheckedRadioButtonId() == -1) {
                    ...
                    if (h.equals("ja") || (h.equals("Nein"))) {
                        Log.d("Button 2 ", "Vorherige RadioButton Auswahl: " + youdData1 + youdData11 + "\t" + youdData2 +
                                ...
                                + gewichtung + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 + gewichtung7 + gewichtung8 + gewichtung9 + gewichtung10 + gewichtung11 +
                                gewichtung12 + gewichtung13 + gewichtung14 + gewichtung15 + gewichtung16 + gewichtung17 + gewichtung18 + gewichtung19 + "aktuelle Auswahl: " + h);
                        radioSexButton.setChecked(true);
                        antwortbutton = h;
                    }

                    if (h.equals("ja")) {
                        antwortwahr = antwortwahrLieferantQualif;
                        gewichtung20 = 2;
                    ...
                    if (h.equals("Nein")) {
                        antwortwahr = antwortfalschLieferantQualif;
                        gewichtung20 = 0;
                        result1 = myDb.updateAntwortJa1(antwortwahr, Fragennummer);
                        if (result1) {
                            Log.d("Successfully 1", "Updated");
                    ...
                    TextView tv = (TextView) root.findViewById(R.id.avg_20tv);
                    tv.setMovementMethod(LinkMovementMethod.getInstance());
                    iq_karfragment = new Lieferant21();
                    bundle = new Bundle();
                    ...
                    bundle.putString("lief_key20", h);
                    bundle.putString("lief_key200", antwortwahr);
