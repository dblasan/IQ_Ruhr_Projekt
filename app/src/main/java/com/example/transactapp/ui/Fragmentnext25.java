...
public class Fragmentnext25 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Fragmentnext27 iq_karfragment;
    FragmentManager fragmentManager;
    public final String Fragennummer = "860";
    ...
    int gewichtung, gew, gewichtung1, gewichtung2, gewichtung3, gewichtung4, gewichtung5,
            ...
            gewichtung18, gewichtung19, gewichtung20;
    public final String antwortWerdenVonWettbewerbgenutzJa = ".";
    public final String antwortWerdenVonWettbewerbgenutzNein = "In den nächsten Jahren ist davon auszugehen, " +
            "dass Ihre Wettbewerber KI nutzen werden.";
    public final String antwortWerdenVonWettbewerbgenutznichtk = "Es ist davon auszugehen, dass Wettbewerber KI bereits nutzen bzw. testen.";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio25, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup25);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets25);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set251);
        bundle = getArguments();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 +
                            "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData29 + ":" + youdData299 +youdData30 + ":" + youdData300 + youdData31 + ":" + youdData311 + gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 + gewichtung4 + gewichtung5 + gewichtung6 +
                            ...
                            gewichtung19 + "\t" + "aktuelle Auswahl: " + h);
                ...
                if (h.equals("ja")) {
                    antwortwahr = antwortWerdenVonWettbewerbgenutzJa;
                    gewichtung20 = 0;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortWerdenVonWettbewerbgenutzNein;
                    gewichtung20 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv25);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragmentnext27();
                bundle = new Bundle();
                ...
                bundle.putString("your_key32", h);
                bundle.putString("your_key322", antwortwahr);
        ...
        TextView linkTextView2 = root.findViewById(R.id.header25);
