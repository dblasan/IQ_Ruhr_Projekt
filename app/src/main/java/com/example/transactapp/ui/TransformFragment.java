...
public class TransformFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ImageView simpleImageView1 = (ImageView) root.findViewById(R.id.transimage);
        simpleImageView1.setImageResource(R.drawable.transformation_1);
        ...
        TextView linkTextView3 = root.findViewById(R.id.transf);
        linkTextView3.setMovementMethod(LinkMovementMethod.getInstance());
        linkTextView3.setTypeface(null, Typeface.BOLD);
        TextView linkTextView4 = root.findViewById(R.id.transtext);
