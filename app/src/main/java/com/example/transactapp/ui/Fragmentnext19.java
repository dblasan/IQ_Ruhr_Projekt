...
public class Fragmentnext19 extends Fragment {

    private FragmentActivity myContext;
    FloatingActionButton fab;
    Fragmentnext20 iq_karfragment;
    FragmentManager fragmentManager;
    public final String Fragennummer = "740";
    ...
    String h, youdData14, youdData13, youdData11, youdData12, youdData15, youdData16,
            ...
            youdData244, youdData255, youdData266, youdData27, youdData277, youdData28, youdData288, youdData29;
    Bundle bundle;
    ...
    int gewichtung, gew, gewichtung1, gewichtung2, gewichtung3, gewichtung4, gewichtung5,
            ...
            gewichtung14, gewichtung15;

    public final String antwortExternerEinsatzJa = ".";
    public final String antwortExternerEinsatzNein = "Wenn Sie Maßnahmen zur digitalen Transformation planen, empfehlen wir Ihnen eine externe Beratung. So ist gewährleistet, " +
            "dass Sie bei Fragen zum Controlling und zum Thema Steuern unterstützt werden.";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.fragment_fragmtestradio19, container, false);
        rgroup = (RadioGroup) root.findViewById(R.id.set_radiogroup19);
        simpleRadioButton1 = (RadioButton) root.findViewById(R.id.two_sets19);
        simpleRadioButton2 = (RadioButton) root.findViewById(R.id.two_set191);
        bundle = getArguments();
            ...
            public void onClick(View view) {
                ...
                if (h.equals("ja") || (h.equals("Nein"))) {
                    Log.d("Button 3", "vorherige Auswahlen : " + youdData11 + ":" + youdData111 + "\t" + youdData12 + ":" + youdData112 + "\t" + youdData13 + ":" + youdData113 + "\t" + youdData14 + ":" + youdData114 +
                            ...
                            youdData26 + ":" + youdData266 +gew + gewichtung + gewichtung1 + gewichtung2 + gewichtung3 +
                            gewichtung4 + gewichtung5 + gewichtung6 + gewichtung7 + gewichtung8 + gewichtung9 +gewichtung10 + gewichtung11 +
                            gewichtung12 + gewichtung13 + gewichtung14 + "\t" + "aktuelle Auswahl: " + h);
                    radioSexButton.setChecked(true);
                    antwortbutton = h;
                }
                if (h.equals("ja")) {
                    antwortwahr = antwortExternerEinsatzJa;
                    gewichtung15 = 0;
                ...
                if (h.equals("Nein")) {
                    antwortwahr = antwortExternerEinsatzNein;
                    gewichtung15 = 0;
                    result1 = myDb.updateAntwortJa(antwortwahr, Fragennummer);
                    if (result1) {
                        Log.d("Successfully 1", "Updated");
                ...
                TextView tv = (TextView) root.findViewById(R.id.avg_testtv19);
                tv.setMovementMethod(LinkMovementMethod.getInstance());
                iq_karfragment = new Fragmentnext20();
                bundle = new Bundle();
                ...
                bundle.putString("your_key27", h);
                bundle.putString("your_key277", antwortwahr);
        ...
        TextView linkTextView2 = root.findViewById(R.id.header19);
